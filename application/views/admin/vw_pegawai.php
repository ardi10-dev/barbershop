				...
				<thead>
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?php base_url('')?>deleteDataPegawai/<?= $p['id_pegawai'];?>" class="badge badge-danger">Hapus</a>
								<a href="<?php base_url()?>pegawai/edit/<?= $p['id_pegawai'];?>" class="badge badge-warning">Edit</a>
								</td>
